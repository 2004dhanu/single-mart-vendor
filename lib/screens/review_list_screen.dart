  ...
  Future<void> _deleteReview(int id) async {
    ...
    final confirm = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        title: const Text('Delete Review', style: TextStyle(color: const Color(0xFF0F172A))),
        content: const Text(
          'Are you sure you want to permanently delete this product review?',
          style: TextStyle(color: const Color(0xFF334155)),
        ),
        actions: [
          TextButton(
            child: const Text('Cancel', style: TextStyle(color: const Color(0xFFF97316))),
